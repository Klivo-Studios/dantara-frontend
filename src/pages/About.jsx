    ...
    <div className="min-h-screen">
      ...
      <section className="bg-[#D26C8D] text-white text-center py-20">
        ...
        <p className="text-xl max-w-3xl mx-auto px-6">
          Providing quality dental care for healthy, confident smiles through
          modern technology and compassionate professionals.
        </p>
      </section>

      {/* Everything below Hero has background */}
      <div className="relative">
        ...
        <div className="relative z-10">
          ...
          <section className="max-w-6xl mx-auto px-6 py-12">
            <div className="grid md:grid-cols-2 gap-10 items-center bg-white/90 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-[0_10px_30px_rgba(210,108,141,0.4)] transition-all duration-300">
              ...
              <div>
                ...
                {showDoctor1 && (
                  <div className="mt-6 border-t pt-4 space-y-3 text-gray-700">
                    ...
                    <p>
                      10+ years of experience in prosthodontics and implant
                      dentistry.
                    </p>
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center bg-white/90 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-[0_10px_30px_rgba(210,108,141,0.4)] transition-all duration-300">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-8">
                  ...
                  about helping patients achieve healthy, confident smiles
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center bg-white/90 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-[0_10px_30px_rgba(210,108,141,0.4)] transition-all duration-300">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-8">
                  ...
                  She is committed to providing gentle, effective dental care
                  and creating a comfortable experience for every patient.
                </p>
          ...
          <section className="py-16">
            <div className="max-w-6xl mx-auto px-6">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="bg-white/90 backdrop-blur-sm p-6 rounded-xl shadow-md hover:-translate-y-2 hover:shadow-[0_10px_30px_rgba(210,108,141,0.3)] transition-all duration-300">
                  <h3 className="font-bold text-xl mb-3">
                    Experienced Dentists
                  </h3>

                  <p>
                    Skilled professionals providing expert dental care with
                    years of experience and patient-focused treatment.
                  </p>
                </div>
                ...
                <div className="bg-white/90 backdrop-blur-sm p-6 rounded-xl shadow-md hover:-translate-y-2 hover:shadow-[0_10px_30px_rgba(210,108,141,0.3)] transition-all duration-300">
                  ...
                  <p>
                    Advanced equipment for accurate diagnosis, comfortable
                    procedures and excellent treatment results.
                  </p>
                </div>
                ...
                <div className="bg-white/90 backdrop-blur-sm p-6 rounded-xl shadow-md hover:-translate-y-2 hover:shadow-[0_10px_30px_rgba(210,108,141,0.3)] transition-all duration-300">
                  ...
                  <p>
                    Personalized care designed to keep every patient relaxed,
                    informed and smiling with confidence.
                  </p>
                </div>
